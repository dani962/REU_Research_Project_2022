...
gso.fire.ts.month.3 = ts(gso.fire.ts.month$n, start = c(2010, 07, 01), end = c(2022, 05, 01), frequency = 12)
#differencing
...
gso.fire.ts.month.true <- ts(gso.fire.ts$n, start = c(2010, 07, 01), end = c(2022, 05, 01), frequency = 12)
```
