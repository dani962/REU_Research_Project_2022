...
We again converted the data into a time series object in order to use the functions for forecasting the time series data.
```{r}
...
First we created a linear regression model without variable selection.
```{r, echo=FALSE}
...
Then we used the function stepAIC for variable selection.
```{r, echo=FALSE}
...
After that we also tried LASSO variable selection with the glmnet function
```{r, echo=FALSE}
