...
In a report analyzing fire service response time by Aleisa and Savsar, it was concluded that with the introduction of centralized systems and navigation technology response time was able to reduce by 32%. This theory was tested using a discrete event simulation. Buffington and Ezekoye were able to record a sufficient correlation between the response time and fire severity through regression analysis. While using the NFIRS dataset they were able to conclude that on average, increasing response times are linked to increasing monetary losses at a rate of about 3000 USD per minute for the interval between 3-13min. In terms of forecasting Li, Zhang, and Fu were able to build a forecasting model that predicted the following 10 years of forest fires in Australia through K-means clustering algorithms and time series forecasting (SARIMA). And similar to our approach, a group of students from the Data Science program at the University of San Francisco were able to use linear regression in machine learning to predict and analyze response times for the San Francisco Fire Department. 
