...
## Outro 
Although multiple studies have sought to capture the analytics behind fire incidents not many have gone completely in-depth in terms of covering fully what factors can affect response time. In this report we aim to completely cover all given factors that may effect fire service response time and how response time effects the rate of total loss in Greensboro, NC. Additionally, to help the Greensboro Fire Departments be better prepared for dealing with future fire incidents in the city, we will build time series models to forecast the future daily/weekly number of fire incidents in the city.
